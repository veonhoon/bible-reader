...
export const translations = {
  en: {
    ...
    totalTeachings: '{{count}} teachings this week',
    dailyTeachings: 'Daily Teachings',
    receiveInsights: 'Receive daily scripture insights',
    getNotified: 'Get notified',
    premium: 'Premium',
    todaysTeaching: "This Week's Teachings",
    weeklyTeaching: "Weekly Teaching",
  ...
  ko: {
    ...
    totalTeachings: '이번 주 가르침 {{count}}개',
    dailyTeachings: '매일의 가르침',
    receiveInsights: '매일 성경 통찰 받기',
    getNotified: '알림 받기',
    premium: '프리미엄',
    todaysTeaching: '이번 주의 가르침',
    weeklyTeaching: '주간 가르침',
    continueWhereYouLeftOff: '이어서 읽기',
